...
class AppSettings implements IAppSettings {
  static const String _AUTO_UPLOAD_ENABLED = 'AUTO_UPLOAD_ENABLED';
  static const String _LOG_FILE_DIRECTORY_PATH = 'LOG_FILE_DIRECTORY_PATH';
  static const String _STORAGE_ACCESS_KEY = 'STORAGE_ACCESS_KEY';
  static const String _STORAGE_BUCKET = 'STORAGE_BUCKET';
  static const String _STORAGE_ENDPOINT = 'STORAGE_ENDPOINT';
  static const String _STORAGE_PORT = 'STORAGE_PORT';
  static const String _STORAGE_REGION = 'STORAGE_REGION';
  static const String _STORAGE_SECRET_KEY = 'STORAGE_SECRET_KEY';
  static const String _STORAGE_TLS_ENABLED = 'STORAGE_TLS_ENABLED';
  static const String _UPLOAD_PROFILES = 'UPLOAD_PROFILES';
  ...
  Future<bool> setLogFileDirectoryPath(String logFileDirectoryPath) async {
    return await setStringSetting(
        _LOG_FILE_DIRECTORY_PATH, logFileDirectoryPath);
  }
